    ...
    <>
      ...
      <section className="bg-black px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row md:items-center py-[50px]">
        ...
        <div className="mt-[50px] md:mt-0">
          <Image
            src="/food.png" // Reference from the `public` directory
            alt="Hero Image"
            width={700}
            height={500}
          />
      ...
      <section className="bg-black px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row md:items-center py-[50px]">
        ...
        {/* About Us Images */}
        <div className="mt-[50px] md:mt-0">
          <Image src="/foodpic1.jpeg" alt="Food Image 1" width={336} height={536} />
          <div className="flex flex-col md:flex-row mt-[16px] md:mt-[0]">
            <Image src="/foodpic2.jpeg" alt="Food Image 2" width={336} height={536} className="mr-[16px] pt-[40px]" />
            <Image src="/foodpic3.jpeg" alt="Food Image 3" width={336} height={536} className="pt-[40px]" />
          </div>
        </div>
      </section>
    </>
